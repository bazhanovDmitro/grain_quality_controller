...
export const ANALIZER_TEXT = "Analizer";

export const REPORTS_TEXT = "Reports";
export const ABOUT_TEXT = "About";
export const CHANGE_CREDENTIALS_TEXT = "Change credentials";
export const EMPLOYEE_LIST_TEXT = "Employee list";
...
export const CHARTS_SIDEBAR_BUTTON_TEXT = "Charts";
export const TOTAL_REPORT_NUMBER = "Total report number";
export const SUCCESSFUL_CASES = "Successful cases";
export const START_DATE_REPORT = "Start date";
export const END_DATE_REPORT = "End date";
